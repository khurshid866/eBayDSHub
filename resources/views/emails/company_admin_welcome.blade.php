...
<head>
    <meta charset="utf-8">
    <title>Company Admin Credentials</title>
    <style>
...
<body>
    <div class="card">
        <div class="logo">⚡ eBay Dropshipping Enterprise Hub</div>
        <h2>Welcome, {{ $user->name }}!</h2>
        <p>Your company <strong>{{ $company->name }}</strong> has been registered on the eBay Dropshipping Hub platform. You have been granted <strong>Company Admin</strong> privileges.</p>
        ...
        <div class="cred-box">
            ...
            <div class="cred-row">
                ...
                <span class="cred-val">{{ $company->code }}</span>
            </div>
        </div>

        <p>As Company Admin, you can log into the portal to manage your store orders, run financial analytics, and create accounts for your Operators.</p>

        <a href="{{ url('/login') }}" class="btn">Log In to Company Portal</a>

        <div class="footer">
            This email was sent automatically by the eBay Dropshipping Hub system. Please keep your login credentials secure.
        </div>
    </div>
</body>
</html>
